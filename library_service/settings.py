...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "1000/day", "user": "3000/day"},  # TODO: Change after end works
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=1000),  # TODO: Change after end works
